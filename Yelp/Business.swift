...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, offset: Int, completion: @escaping (Int?, [Business]?, Error?) -> Void) {
        _ = YelpClient.sharedInstance.searchWithTerm(term, offset: offset, completion: completion)
    }
    
    class func searchWithTerm(term: String, sort: Int?, categories: [String]?, deals: Bool?, radius: Int?, offset: Int, completion: @escaping (Int?, [Business]?, Error?) -> Void) -> Void {
